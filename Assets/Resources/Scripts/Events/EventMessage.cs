...
public abstract class EventMessage<E, P1, P2, P3, P4, P5> : EventMessage
    where E : EventMessage<E, P1, P2, P3, P4, P5>, new()
{
    protected static readonly E cache = new();
    ...
    public static E GetEvent(P1 param1, P2 param2, P3 param3, P4 param4, P5 param5)
    {
        cache.param1 = param1;
        cache.param2 = param2;
        cache.param3 = param3;
...
public abstract class EventMessage<E, P1, P2, P3, P4, P5, P6> : EventMessage
    where E : EventMessage<E, P1, P2, P3, P4, P5, P6>, new()
{
    protected static readonly E cache = new();
    ...
    public static E GetEvent(P1 param1, P2 param2, P3 param3, P4 param4, P5 param5, P6 param6)
    {
        cache.param1 = param1;
        cache.param2 = param2;
        cache.param3 = param3;
